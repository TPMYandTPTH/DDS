...
A Flask application to split Word documents into individual 2-page job descriptions
"""
        ...
        <div class="main-card">
            ...
            <div class="header-section">
                <div class="logo-placeholder">
                    <i class="fas fa-file-word" style="font-size: 80px; margin-bottom: 20px;"></i>
                </div>
                <h1>DDS</h1>
            ...
            <div class="content-section">
                ...
                <div class="info-box">
                    ...
                    <ul>
                        <li>Upload your Word document (.docx or .docm)</li>
                        <li>System automatically splits every 2 pages into separate files</li>
                        <li>Download all files as a convenient ZIP archive</li>
                        <li>Perfect for processing multiple job descriptions</li>
                    </ul>
                </div>
                ...
                <div class="upload-zone" id="upload-zone">
                    ...
                    <p class="text-muted mt-2">Supported formats: .docx, .docm (Max 50MB)</p>
                    <p class="file-name" id="file-name"></p>
                </div>

                <input type="file" id="file-input" accept=".docx,.docm">
                ...
                <div class="progress-section" id="progress-section">
                    ...
                    <p class="text-center text-muted">This may take a few moments</p>
                </div>
                ...
                <div class="result-section" id="result-section">
                    ...
                    <div class="mt-4">
                        <a href="#" id="download-link" class="btn-custom btn-primary-custom">
                            <i class="fas fa-download me-2"></i>Download All Files (ZIP)
                        </a>
                    </div>

                    <button class="btn-custom btn-primary-custom mt-3" id="reset-btn" style="background: var(--gray-color);">
        ...
        <footer>
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0" style="color: var(--secondary-color); font-weight: bold; font-size: 1.1rem;">
                        #MoreTogether
                    </p>
                </div>
            </div>
    ...
    <script>
        ...
        function handleFileSelect() {
            if (fileInput.files.length > 0) {
                ...
                if (!selectedFile.name.endsWith('.docx') && !selectedFile.name.endsWith('.docm')) {
                    showAlert('Please select a valid Word document (.docx or .docm)', 'danger');
                    resetFileInput();
                    return;
                }
        ...
        splitBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    downloadLink.href = `/download/${data.session_id}`;
                ...
                progressSection.style.display = 'none';
                showAlert(error.message || 'An error occurred while processing your file.', 'danger');
                splitBtn.disabled = false;
            }
        });
        ...
        fetch('/health')
            ...
            .then(data => {
                if (data.status !== 'healthy') {
                    showAlert('Server connection issue detected.', 'warning');
                }
            })
            .catch(() => {
                showAlert('Cannot connect to server. Please refresh the page.', 'danger');
            });
    </script>
</body>
</html>
...
def split_document_by_pages(input_path, pages_per_file=2):
    ...
    try:
        ...
        # Count total pages (approximate by counting page breaks)
        ...
        num_files = (estimated_pages + pages_per_file - 1) // pages_per_file
        
        # Create output directory
        output_dir = tempfile.mkdtemp()
        output_files = []
        
        # For Word documents, we'll split by page breaks
        current_doc = Document()
        current_doc.sections[0].page_height = doc.sections[0].page_height
        current_doc.sections[0].page_width = doc.sections[0].page_width
        current_doc.sections[0].left_margin = doc.sections[0].left_margin
        current_doc.sections[0].right_margin = doc.sections[0].right_margin
        current_doc.sections[0].top_margin = doc.sections[0].top_margin
        current_doc.sections[0].bottom_margin = doc.sections[0].bottom_margin
